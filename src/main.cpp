...
int64 nChainStartTime = 1423184729;
...
const string strMessageMagic = "NineElevenTruthCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 110000000  * COIN;	// 110,000,000 coins Premine
		return nSubsidy + nFees;
	}
    if (nHeight <= 2880) {
         nSubsidy = 911 * COIN; // 911 Coins Per Block For 2 days
        return nSubsidy + nFees;   
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NineElevenTruthCoin
    bool fStrictPayToScriptHash = true; // Always active in NineElevenTruthCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NineElevenTruthCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "February 6, 2015. US Mulls Course on Ukraine: Diplomacy or Weapons. 1423184729";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1423184729;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1667750;
        ...
        assert(block.hashMerkleRoot == uint256("224f7249995bc0cc9fdf9793503d1738e4a586e9e685494ead9204c58a1e3a3a"));
